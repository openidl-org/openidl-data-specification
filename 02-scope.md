...
# Objectives
The objective of this Working Group is to document the existing de facto standard as the initial OpenIDS Data Specification and put the specification on a standards track. Once the work on defining the Base specification is sufficiently far along, the Working Group will develop additional versions of the specification evolving from the initial specification.
